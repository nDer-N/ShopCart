                ...
                <div className='flex'>
                    {visible && (
                        ...
                        <form className='flex flex-col gap-3' action="" onSubmit={onClick}>
                            ...
                            <button className="m-2 bg-yellow-400 hover:bg-yellow-500 active:scale-95 active:bg-orange-400 text-white font-bold py-2 px-4 rounded transition-all duration-[190ms] ease-in-out mt-2" onClick={()=>(onClick())}>Add Item</button>
                        </form>
